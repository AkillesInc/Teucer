...
namespace CoGaDB {
    ...
    public:
        ...
        static const LookupTablePtr aggregate(const std::string& result_lookup_table_name, const LookupTable& lookup_table, const LookupColumn& lookup_col, const ProcessorSpecification& proc_spec);
	...
	virtual bool remove(const std::string& attribute_name, const boost::any& value);
        ...
        virtual bool replaceColumn(const std::string& column_name, const ColumnPtr new_column);
    ...
    private:
        ...
        std::vector<ColumnPtr> lookup_arrays_to_real_columns_; //each column from this list corresponds to the same entry in schema_
