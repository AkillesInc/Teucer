...
namespace CoGaDB{
    ...
    public:
            EquiHeightHistogram(ColumnBaseTyped<T>* col, unsigned int number_of_buckets = 100);
            EquiHeightHistogram(const T* array, size_t array_size, unsigned int number_of_buckets = 100);
            ...
            virtual double getEstimatedSelectivity(const Predicate& lower_pred, const Predicate& upper_pred) const;        
            virtual std::string getName() const;
            virtual SelectivityEstimationStrategy getSelectivityEstimationStrategy() const;
