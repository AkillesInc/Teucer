...
#define COGADB_EXECUTE_GPU_OPERATOR(name_of_gpu_operator) \
                    ...
                    StatisticsManager::instance().addToValue(std::string("NUMBER_OF_EXECUTED_")+name_of_gpu_operator+"_OPERATORS",1); \
...
#define COGADB_ABORT_GPU_OPERATOR(name_of_gpu_operator) \
                    ...
                    StatisticsManager::instance().addToValue(std::string("NUMBER_OF_ABORTED_")+name_of_gpu_operator+"_OPERATORS",1); \
                    uint64_t end_timestamp_aborted_gpu_operator_time = getTimestamp(); \
                    StatisticsManager::instance().addToValue("TOTAL_LOST_TIME_IN_NS_DUE_TO_ABORTED_GPU_OPERATORS",double(end_timestamp_aborted_gpu_operator_time-begin_timestamp_aborted_gpu_operator_time)); \
                    StatisticsManager::instance().addToValue(std::string("LOST_TIME_IN_NS_DUE_TO_ABORTED")+name_of_gpu_operator+"_OPERATOR",double(end_timestamp_aborted_gpu_operator_time-begin_timestamp_aborted_gpu_operator_time)); \
                    has_aborted_=true;}
