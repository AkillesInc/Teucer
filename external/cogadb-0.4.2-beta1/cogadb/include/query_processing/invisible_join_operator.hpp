...
namespace CoGaDB {
    namespace query_processing {
        namespace physical_operator {
            ...
            class CPU_InvisibleJoin_Operator : public hype::queryprocessing::UnaryOperator<TablePtr, TablePtr> {
            public:
                typedef hype::queryprocessing::OperatorMapper_Helper_Template<TablePtr>::TypedOperatorPtr TypedOperatorPtr;

                CPU_InvisibleJoin_Operator(const hype::SchedulingDecision& sched_dec,
...
//                    this->result_ = query_processing::two_phase_physical_optimization_selection(this->getInputData(), dimensions_, mat_stat_);
//#else
//                    this->result_ = BaseTable::selection(this->getInputData(), dimensions_, mat_stat_, SERIAL);
//#endif
//                    if (this->result_)
//                        return true;
//                    else
...
//                }
            ...
            TypedOperatorPtr create_CPU_InvisibleJoin_Operator(TypedLogicalNode& logical_node, const hype::SchedulingDecision&, TypedOperatorPtr left_child, TypedOperatorPtr right_child);
        ...
        namespace logical_operator {
            ...
            class Logical_InvisibleJoin : public hype::queryprocessing::TypedNode_Impl<TablePtr, physical_operator::map_init_function_invisible_join_operator> //init_function_InvisibleJoin_operator>
            {
            public:

                Logical_InvisibleJoin(const InvisibleJoinSelectionList& dimensions,
                        MaterializationStatus mat_stat = LOOKUP,
                        hype::DeviceConstraint dev_constr = CoGaDB::RuntimeConfiguration::instance().getGlobalDeviceConstraint() // = hype::DeviceConstraint()
                        ) : TypedNode_Impl<TablePtr, physical_operator::map_init_function_invisible_join_operator>(false, dev_constr),
                dimensions_(dimensions),
                mat_stat_(mat_stat){
                }
