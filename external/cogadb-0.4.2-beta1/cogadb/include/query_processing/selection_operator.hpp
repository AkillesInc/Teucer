        ...
        namespace physical_operator {
            ...
            public:
                ...
                virtual bool execute() {
                    ...
                    SelectionParam param(proc_spec, pred_.getPredicateType(), pred_.getConstant(),pred_.getValueComparator());
                    this->result_ = BaseTable::selection(this->getInputData(), pred_.getColumn1Name(), param);
