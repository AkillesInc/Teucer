...
namespace CoGaDB {
    namespace query_processing {
        namespace physical_operator {
            ...
            class Join_Operator : public hype::queryprocessing::BinaryOperator<TablePtr, TablePtr, TablePtr> {
            public:
                ...
                Join_Operator(const hype::SchedulingDecision& sched_dec,
                        ...
                        const JoinParam& join_param) : BinaryOperator<TablePtr, TablePtr, TablePtr>(sched_dec, left_child, right_child),
                ...
                virtual bool execute() {
                    ...
                    ProcessorSpecification proc_spec(sched_dec_.getDeviceSpecification().getProcessingDeviceID());
                    JoinParam join_param(proc_spec, join_param_.join_alg, join_param_.join_type);
                                   
                    if(!is_semi_join(this->join_param_.join_type)){
                        this->result_ = BaseTable::join(this->getInputDataLeftChild(), join_column1_name_, this->getInputDataRightChild(), join_column2_name_, join_param);
                    }else{
                        this->result_ = BaseTable::semi_join(this->getInputDataLeftChild(), join_column1_name_, this->getInputDataRightChild(), join_column2_name_, join_param);
                    }
                    if (this->result_) {
			...
			TypedOperatorPtr create_NestedLoopJoin_Operator(TypedLogicalNode& logical_node, const hype::SchedulingDecision&, TypedOperatorPtr left_child, TypedOperatorPtr right_child);
			TypedOperatorPtr create_SortMergeJoin_Operator(TypedLogicalNode& logical_node, const hype::SchedulingDecision&, TypedOperatorPtr left_child, TypedOperatorPtr right_child);
			TypedOperatorPtr create_HashJoin_Operator(TypedLogicalNode& logical_node, const hype::SchedulingDecision&, TypedOperatorPtr left_child, TypedOperatorPtr right_child);		
//			TypedOperatorPtr create_Parallel_HashJoin_Operator(TypedLogicalNode& logical_node, const hype::SchedulingDecision&, TypedOperatorPtr left_child, TypedOperatorPtr right_child);
			...
			TypedOperatorPtr create_IndexNestedLoop_Join_Operator(TypedLogicalNode& logical_node, const hype::SchedulingDecision&, TypedOperatorPtr left_child, TypedOperatorPtr right_child);
