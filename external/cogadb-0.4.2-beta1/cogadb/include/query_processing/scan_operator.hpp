...
namespace CoGaDB {
    namespace query_processing {
        namespace physical_operator {
            ...
            class scan_operator : public hype::queryprocessing::UnaryOperator<TablePtr, TablePtr> {
            public:
        ...
        //Map_Init_Function init_function_scan_operator=physical_operator::map_init_function_scan_operator; //boost::bind();

        //Map_Init_Function getMap_Init_Function_Scan_Operation();

        namespace logical_operator {

            class Logical_Scan : public hype::queryprocessing::TypedNode_Impl<TablePtr, physical_operator::map_init_function_scan_operator> //init_function_scan_operator> //init_function_scan_operator>
            {
            public:
