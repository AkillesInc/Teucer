...
//
//            class Logical_CPU_ColumnAlgebraOperation : public hype::queryprocessing::TypedNode_Impl<ColumnPtr, physical_operator::map_init_function_cpu_column_algebra_operator> //init_function_Join_operator>
//            {
//            public:
//
...
//                : TypedNode_Impl<ColumnPtr, physical_operator::map_init_function_cpu_column_algebra_operator>(false, dev_constr),
//                op_(op),
//                mat_stat_(mat_stat) {
//                }
//
