...
namespace CoGaDB {
    namespace query_processing {
        namespace physical_operator {
            ...
            class column_scan_operator : public hype::queryprocessing::UnaryOperator<ColumnPtr, ColumnPtr> {
            public:
        ...
        namespace logical_operator {
            ...
            class Logical_Column_Scan : public hype::queryprocessing::TypedNode_Impl<ColumnPtr, physical_operator::map_init_function_column_scan_operator> //init_function_column_scan_operator> //init_function_column_scan_operator>
            {
            public:
