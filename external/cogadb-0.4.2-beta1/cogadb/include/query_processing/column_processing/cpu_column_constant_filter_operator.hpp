...
namespace CoGaDB {
    namespace query_processing {
        namespace physical_operator {
            ...
            class CPU_column_constant_filter_operator : public hype::queryprocessing::UnaryOperator<ColumnPtr, ColumnPtr>, public PositionListOperator {
            public:
...
//            class GPU_column_constant_filter_operator : public hype::queryprocessing::UnaryOperator<ColumnPtr, ColumnPtr>, public PositionListOperator {
//            public:
//                typedef column_processing::cpu::TypedOperatorPtr TypedOperatorPtr;
...
//            column_processing::cpu::TypedOperatorPtr create_GPU_column_constant_filter_operator(column_processing::cpu::TypedLogicalNode& logical_node, const hype::SchedulingDecision&, column_processing::cpu::TypedOperatorPtr left_child, column_processing::cpu::TypedOperatorPtr right_child);
        ...
        namespace logical_operator {
            ...
            class Logical_Column_Constant_Filter : public hype::queryprocessing::TypedNode_Impl<ColumnPtr, physical_operator::map_init_function_column_constant_filter_operator> //init_function_column_constant_filter_operator> //init_function_column_constant_filter_operator>
            {
            public:
