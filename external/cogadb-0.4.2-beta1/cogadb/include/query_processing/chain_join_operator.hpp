...
namespace CoGaDB {
    namespace query_processing {
        ...
        struct ChainJoinSpecification{
            ...
            ChainJoinSpecification(const optimizer::JoinPath& a_join_path, const SelectionMap& a_sel_map) 
        ...
        namespace physical_operator {
            ...
            class Chain_Join_Operator : public hype::queryprocessing::UnaryOperator<TablePtr, TablePtr> {
            public:
                typedef hype::queryprocessing::OperatorMapper_Helper_Template<TablePtr>::TypedOperatorPtr TypedOperatorPtr;

                Chain_Join_Operator(const hype::SchedulingDecision& sched_dec,
            ...
            TypedOperatorPtr create_Chain_Join_Operator(TypedLogicalNode& logical_node, const hype::SchedulingDecision&, TypedOperatorPtr left_child, TypedOperatorPtr right_child);
        ...
        namespace logical_operator {
            ...
            class Logical_ChainJoin : public hype::queryprocessing::TypedNode_Impl<TablePtr, physical_operator::map_init_function_chain_join_operator> //init_function_InvisibleJoin_operator>
            {
            public:

                Logical_ChainJoin(const ChainJoinSpecification& chain_join_specification,
                        MaterializationStatus mat_stat = LOOKUP,
                        hype::DeviceConstraint dev_constr = CoGaDB::RuntimeConfiguration::instance().getGlobalDeviceConstraint() // = hype::DeviceConstraint()
                        ) : TypedNode_Impl<TablePtr, physical_operator::map_init_function_chain_join_operator>(false, dev_constr),
                chain_join_specification_(chain_join_specification),
                mat_stat_(mat_stat){
                }
