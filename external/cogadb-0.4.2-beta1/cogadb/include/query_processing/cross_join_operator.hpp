...
namespace CoGaDB {
    namespace query_processing {
        namespace physical_operator {
            ...
            class CPU_CrossJoin_Operator : public hype::queryprocessing::BinaryOperator<TablePtr, TablePtr, TablePtr> {
            public:
                ...
                virtual bool execute() {
                    ...
                    this->result_ = BaseTable::crossjoin(this->getInputDataLeftChild(), this->getInputDataRightChild(), mat_stat_);
                    if (this->result_) {
        ...
        namespace logical_operator {
            ...
            class Logical_CrossJoin : public hype::queryprocessing::TypedNode_Impl<TablePtr, physical_operator::map_init_function_crossjoin_operator> //init_function_Join_operator>
            {
            public:

                Logical_CrossJoin(MaterializationStatus mat_stat = MATERIALIZE,
                        hype::DeviceConstraint dev_constr = hype::DeviceConstraint()
                        ) : TypedNode_Impl<TablePtr, physical_operator::map_init_function_crossjoin_operator>(false, dev_constr),
                join_column1_name_(),
                join_column2_name_(),
                mat_stat_(mat_stat) {
                }
