...
namespace CoGaDB {
    namespace query_processing {
        namespace physical_operator {
            ...
            class CPU_ColumnAlgebraOperator : public hype::queryprocessing::UnaryOperator<TablePtr, TablePtr> {
            public:
                ...
                virtual bool execute() {
                    ...
                    this->result_ = BaseTable::ColumnAlgebraOperation(this->getInputData(), column1_name_, column2_name_, result_column_name_, algebra_param);
        ...
        //Map_Init_Function init_function_sort_operator=physical_operator::map_init_function_column_algebra_operator; //boost::bind();

        namespace logical_operator {

            class Logical_ColumnAlgebraOperator : public hype::queryprocessing::TypedNode_Impl<TablePtr, physical_operator::map_init_function_column_algebra_operator> //init_function_sort_operator>
            {
            public:

                Logical_ColumnAlgebraOperator(const std::string& column1_name,
                        const std::string& column2_name,
                        const std::string& result_col_name,
                        ColumnAlgebraOperation operation,
