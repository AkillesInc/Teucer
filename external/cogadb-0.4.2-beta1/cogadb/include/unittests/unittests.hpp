...
//	
//	{Tuple t; t.push_back(1); t.push_back(string("INF"));				if(!tab1->insert(t)) cout << "Failed to insert Tuple" << endl;}
...
//	{Tuple t; t.push_back(1); t.push_back(string("Peter")); t.push_back(24); t.push_back(float(23.1));				tab1->insert(t);}
//	{Tuple t; t.push_back(2); t.push_back(string("James"));	t.push_back(20);	t.push_back(float(40.6));								tab1->insert(t);}
//	{Tuple t; t.push_back(3); t.push_back(string("Karl")); t.push_back(30);	t.push_back(float(99.4));			tab1->insert(t);}
//	{Tuple t; t.push_back(4); t.push_back(string("Max"));	t.push_back(17);	t.push_back(float(10.8));		tab1->insert(t);}
//	{Tuple t; t.push_back(5); t.push_back(string("Bob")); t.push_back(21); t.push_back(float(84.2));	tab1->insert(t);}
//	{Tuple t; t.push_back(6); t.push_back(string("Alice")); t.push_back(22); t.push_back(float(30.6));	tab1->insert(t);}
//	{Tuple t; t.push_back(7); t.push_back(string("Susanne")); t.push_back(25);	t.push_back(float(29.3));	tab1->insert(t);}
//	{Tuple t; t.push_back(8); t.push_back(string("Joe"));	t.push_back(40);	t.push_back(float(72.0)); tab1->insert(t);}
////%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5

//	{Tuple t; t.push_back(9); t.push_back(string("Maik")); t.push_back(33); t.push_back(float(95.4));	tab1->insert(t);}
//	{Tuple t; t.push_back(10); t.push_back(string("Anne")); t.push_back(16); t.push_back(float(52.3));	tab1->insert(t);}
//	{Tuple t; t.push_back(11); t.push_back(string("Jenny")); t.push_back(9); t.push_back(float(5.0));	tab1->insert(t);}
//	
//	tab1->print();

////	TablePtr tab2=BaseTable::selection(tab1,string("Age"),int(24),LESSER,MATERIALIZE,GPU);
////	tab2->print();
...
//	gpu::GPU_PositionlistPtr gpu_result_tids = gpu::GPU_Operators::selection(dev_col, int(24), LESSER);
//	assert(gpu_result_tids!=NULL);
//	
////	gpu::GPU_Base_ColumnPtr dev_col_2 = gpu::materializeColumn(dev_col,gpu_result_tids); //create materialized GPU column from existing GPU Column and result tid list 
////	gpu_result_tids->print();
//	cout << endl << "Materialize..." << endl;
//	gpu::GPU_Base_ColumnPtr dev_col_2 = dev_col->materialize(gpu_result_tids); //create materialized GPU column from existing GPU Column and result tid list 
//	dev_col_2->print();
//	cout << endl << "Perform Sort..." << endl;
//	gpu::GPU_PositionlistPtr gpu_result_tids2 = gpu::GPU_Operators::sort( dev_col_2, ASCENDING);  //perform next operation
//	gpu_result_tids2->print();
//	cout << endl << "Aggregate Lookup Tables..." << endl;
//	gpu::GPU_PositionlistPtr gpu_aggregated_result_positionlist = gpu_result_tids->aggregate(gpu_result_tids2);
//	gpu_aggregated_result_positionlist->print();
//	PositionListPtr result_tids = copy_PositionList_device_to_host(gpu_aggregated_result_positionlist);
//	assert(result_tids!=NULL);	

//	TablePtr tab2 = createLookupTableforUnaryOperation(std::string("Lookup_selection_and_sort(")+tab1->getName()+")",tab1, result_tids );
//	assert(tab2!=NULL);
//	tab2->print();	
//	}
//	
...
//	gpu::GPU_Base_ColumnPtr dev_col3 = gpu::copy_column_host_to_device(col2);
//	
//	gpu::GPU_Base_ColumnPtr dev_col_4 = dev_col3->materialize(gpu_result_tids); //create materialized GPU column from existing GPU Column and result tid list 
//	
//	dev_col_4->print();
//	cout << endl << "Perform Sort..." << endl;
//	gpu::GPU_PositionlistPtr gpu_result_tids2 = gpu::GPU_Operators::sort( dev_col_4, ASCENDING);  //perform next operation
//	gpu_result_tids2->print();
//	cout << endl << "Aggregate Lookup Tables..." << endl;
//	gpu::GPU_PositionlistPtr gpu_aggregated_result_positionlist = gpu_result_tids->aggregate(gpu_result_tids2);
//	gpu_aggregated_result_positionlist->print();
...
////			static const GPU_PositionlistPtr sort(GPU_Base_ColumnPtr column); 
...
////			//join algorithms
//////			static const std::pair<GPU_Positionlist*,GPU_Positionlist*> gpu_join(GPU_Base_Column* join_column1, GPU_Base_Column* join_column2, JoinAlgorithm join_alg);
////			static const std::pair<GPU_Base_ColumnPtr,GPU_Base_ColumnPtr> groupby(GPU_Base_ColumnPtr grouping_column, 
...
////			static const std::pair<GPU_PositionlistPtr,GPU_PositionlistPtr>  hash_join(GPU_Base_ColumnPtr join_column1, GPU_Base_ColumnPtr join_column2);
////			static const std::pair<GPU_PositionlistPtr,GPU_PositionlistPtr>  sort_merge_join(GPU_Base_ColumnPtr join_column1, GPU_Base_ColumnPtr join_column2);
////			static const std::pair<GPU_PositionlistPtr,GPU_PositionlistPtr>  nested_loop_join(GPU_Base_ColumnPtr join_column1, GPU_Base_ColumnPtr join_column2);




////	gpu::GPU_Positionlist* gpu_result_tids = gpu::GPU_Operators::selection(gpu::GPU_Base_Column* column, int(24), LESSER);




////	TablePtr tab3=BaseTable::selection(tab1,string("Age"),int(24),LESSER,MATERIALIZE,GPU);
////	tab3->print();

//	return true;
//}

//vector<int> generate_dataset(unsigned int size_in_number_of_elements, unsigned int maximal_value_size){
//	vector<int> data;2
...
//TablePtr selectionCPU(TablePtr tab, int selection_value, ValueComparator comp){

//		
//	return BaseTable::selection(tab,string("Number"),selection_value,comp,LOOKUP,SERIAL);

//}

//TablePtr selectionCPU_parallel(TablePtr tab, int selection_value, ValueComparator comp){

//		
//	return BaseTable::selection(tab,string("Number"),selection_value,comp,LOOKUP,PARALLEL);

//}

//TablePtr selectionGPU(TablePtr tab, int selection_value, ValueComparator comp){
...
//	assert(dev_col!=NULL);	
//	
//	gpu::GPU_PositionlistPtr gpu_result_tids = gpu::GPU_Operators::selection(dev_col, selection_value, comp);
//	assert(gpu_result_tids!=NULL);
//	
//	PositionListPtr result_tids = copy_PositionList_device_to_host(gpu_result_tids);
//	assert(result_tids!=NULL);	

//	return createLookupTableforUnaryOperation(std::string("Lookup_selection(")+tab->getName()+")",tab, result_tids );
//	
//}

//bool Unittest_GPU_Selection_Benchmark(unsigned int number_of_runs, std::string logfilename){
//	srand(0);
//	//const unsigned int MAX_DATASET_SIZE=(10*1000*1000)/sizeof(int); //1000000;
//	const unsigned int MAX_DATASET_SIZE=(50*1024*1024)/sizeof(int); //(50*1000*1000)/sizeof(int); //1000000;
...
//	
//		cout << "Run: " << i << "/" << number_of_runs << "   Elements to Process: " << dataset.size() <<  endl;
...
//		TablePtr tab_cpu_parallel = selectionCPU_parallel(tab1, selection_value, comp);
...
//		ColumnPtr col_cpu_parallel = tab_cpu_parallel -> getColumnbyName("Number");
...
//		file << dataset.size() << "	" << selectivity << "	" << comp 
//		     << "	" << end_cpu - begin_cpu 
//		     << "	" << end_gpu-begin_gpu  
//		     << "	" << end_cpu_parallel - begin_cpu_parallel
//		     << endl;
//		cout << "number of elements: " << dataset.size() << "	selectivity: " <<  selectivity  << "	comparison_value: "  << comp  
//		     << "	CPU: " << end_cpu - begin_cpu 
//		     << "	GPU: " << end_gpu-begin_gpu  
//		     << "	CPU parallel: " << end_cpu_parallel - begin_cpu_parallel 
//		     << endl;
...
//	//TablePtr tab3 = BaseTable::join(tab1,"SID",tab2,"SID",SORT_MERGE_JOIN,MATERIALIZE,CPU);
//	//TablePtr tab3 = BaseTable::join(tab1,"SID",tab2,"SID",NESTED_LOOP_JOIN,MATERIALIZE,CPU);

//	//TablePtr tab3 = BaseTable::join(tab1,"SID",tab2,"SID",SORT_MERGE_JOIN,MATERIALIZE,CPU);
//	//TablePtr tab3 = BaseTable::join(tab1,"SID",tab2,"SID",SORT_MERGE_JOIN,LOOKUP,CPU);


//	TablePtr tab3 = BaseTable::join(tab1,"SID",tab2,"SID",NESTED_LOOP_JOIN,MATERIALIZE,CPU);
//				tab3->print();
//				cout << "==========================================================================================" << endl;
//				tab3 = BaseTable::join(tab1,"SID",tab2,"SID",NESTED_LOOP_JOIN,LOOKUP,CPU);
...
//		TablePtr tab4=BaseTable::selection(tab3,string("Studiengang"),string("INF"),EQUAL,MATERIALIZE,CPU);
//				tab4->print();
//				cout << "==========================================================================================" << endl;
...
//	JoinAlgorithm join_alg = HASH_JOIN; //NESTED_LOOP_JOIN; // HASH_JOIN; //SORT_MERGE_JOIN; //HASH_JOIN; //NESTED_LOOP_JOIN NESTED_LOOP_JOIN

//	{
//	cout << endl << "Join Table Studenten, Studiengänge where Studenten.SID=Studiengänge.SID ..." << endl;

//	TablePtr tab3 = BaseTable::join(tab1,"SID",tab2,"SID",join_alg,MATERIALIZE,CPU);
//				tab3->print();
...
//	TablePtr tab3 = BaseTable::join(tab1,"SID",tab2,"SID",join_alg,LOOKUP,CPU);
//				tab3->print();
...
//void executeTestQuery(TablePtr tab1, TablePtr tab2, JoinAlgorithm join_alg, MaterializationStatus mat_stat, const ComputeDevice comp_dev){
...
//	TablePtr tab3 = BaseTable::join(tab1,"ID",tab2,"EID",join_alg,mat_stat,comp_dev);
//				if(!quiet && verbose)tab3->print();

//		//cout << "Selection on Table on column Alter greater than 60..." << endl;

//		//ValueComparator{LESSER,GREATER,EQUAL};
//		TablePtr tab4=BaseTable::selection(tab3,string("Alter"),60,GREATER,mat_stat,SERIAL);
//					if(!quiet && verbose)tab4->print();

//		//cout << "Sorting Table by Alter (ascending)..." << endl;

//		TablePtr tab5=BaseTable::sort(tab4,"Alter",ASCENDING,mat_stat,CPU);
...
//void Unittest_Test_Benchmark(size_t size_of_main_table=20, size_t size_of_foreign_key_table=100, unsigned int number_of_runs_per_query=20){
...
//	end=getTimestamp();
//	assert(end>=begin);
//	cout << "Time for Query: " << end-begin << "ns (" << double(end-begin)/1000000 << "ms)" << endl;
//	cout << "==========================================================================================" << endl;
//	}
//	for(unsigned int i=0;i<number_of_runs_per_query;i++){
...
//	}
////	for(unsigned int i=0;i<number_of_runs_per_query;i++){
////	cout << "Query: Materialize Table		Join: Nested Loop Join " << endl;
////	Timestamp begin,end; 
////	begin=getTimestamp();
...
////	}
////	for(unsigned int i=0;i<number_of_runs_per_query;i++){
////	cout << "Query: Lookup Table		Join: Nested Loop Join " << endl;
////	Timestamp begin,end; 
////	begin=getTimestamp();
...
////	TablePtr tab3 = BaseTable::join(tab1,"ID",tab2,"EID",NESTED_LOOP_JOIN,MATERIALIZE,CPU);
////	if(!quiet && verbose) tab3->print();

////	cout << "==========================================================================================" << endl;
////	cout << "Lookup Table Nested Loop Join " << endl;
////	tab3 = BaseTable::join(tab1,"ID",tab2,"EID",NESTED_LOOP_JOIN,LOOKUP,CPU);
////	if(!quiet && verbose) tab3->print();
////	cout << "==========================================================================================" << endl;
////	cout << "Materialize Table Sort Merge Join " << endl;	
////	tab3 = BaseTable::join(tab1,"ID",tab2,"EID",SORT_MERGE_JOIN,MATERIALIZE,CPU);
////	if(!quiet && verbose) tab3->print();
////	cout << "==========================================================================================" << endl;
...
//void ColumnJoinBenchmark(size_t size_of_main_table=20, size_t size_of_foreign_key_table=100, unsigned int number_of_runs_per_query=20){
...
//	cout << "Filling Table Autos with " << size_of_foreign_key_table << " rows" << endl;
...
//		Timestamp begin,end; 
//		begin=getTimestamp();
//		TablePtr tab4 = BaseTable::join(tab1,"ID",tab2,"EID", SORT_MERGE_JOIN, MATERIALIZE,CPU);
//		assert(tab4!=NULL);
//		//tab4->print();
//		TablePtr tab5 = BaseTable::join(tab4,"ID",tab3,"AID", SORT_MERGE_JOIN, MATERIALIZE,CPU);
//		//tab5->print();
//		end=getTimestamp();
//		assert(end>=begin);
//		if(!quiet && verbose)tab3->print();
...
//		Timestamp begin,end; 
//		begin=getTimestamp();
//		TablePtr tab4 = BaseTable::join(tab1,"ID",tab2,"EID", SORT_MERGE_JOIN, LOOKUP,CPU);
//		assert(tab4!=NULL);
//		TablePtr tab5 = BaseTable::join(tab4,"ID",tab3,"AID", SORT_MERGE_JOIN, LOOKUP,CPU);
...
//		Timestamp begin,end; 
//		begin=getTimestamp();
//		TablePtr tab4 = BaseTable::join(tab1,"ID",tab2,"EID", NESTED_LOOP_JOIN, MATERIALIZE,CPU);
//		assert(tab4!=NULL);
//		//tab4->print();
//		TablePtr tab5 = BaseTable::join(tab4,"ID",tab3,"AID", NESTED_LOOP_JOIN, MATERIALIZE,CPU);
//		//tab5->print();
//		end=getTimestamp();
//		assert(end>=begin);
//		if(!quiet && verbose) tab3->print();
...
//		Timestamp begin,end; 
//		begin=getTimestamp();
//		TablePtr tab4 = BaseTable::join(tab1,"ID",tab2,"EID", NESTED_LOOP_JOIN, LOOKUP,CPU);
//		assert(tab4!=NULL);
//		TablePtr tab5 = BaseTable::join(tab4,"ID",tab3,"AID", NESTED_LOOP_JOIN, LOOKUP,CPU);
//		cout << "Result: " << endl;
//		//tab5->print();
//		TablePtr tab6 = tab5->materialize();
...
//		}*/
//		{
//  		 cout << "Query: Materialize Table		Join: Hash Join " << endl;
//		Timestamp begin,end; 
//		begin=getTimestamp();
//		TablePtr tab4 = BaseTable::join(tab1,"ID",tab2,"EID", HASH_JOIN, MATERIALIZE,CPU);
//		assert(tab4!=NULL);
//		//tab4->print();
//		TablePtr tab5 = BaseTable::join(tab4,"ID",tab3,"AID", HASH_JOIN, MATERIALIZE,CPU);
//		//tab5->print();
//		end=getTimestamp();
//		assert(end>=begin);
//		if(!quiet && verbose)tab3->print();
...
//		{
//  		 cout << "Query: Lookup Table		Join: Hash Join " << endl;
//		Timestamp begin,end; 
//		begin=getTimestamp();
//		TablePtr tab4 = BaseTable::join(tab1,"ID",tab2,"EID", HASH_JOIN, LOOKUP,CPU);
//		assert(tab4!=NULL);
//		TablePtr tab5 = BaseTable::join(tab4,"ID",tab3,"AID", HASH_JOIN, LOOKUP,CPU);
//		cout << "Result: " << endl;
//		//tab5->print();
//		TablePtr tab6 = tab5->materialize();
//		cout << "Materialized Result: " << endl;
