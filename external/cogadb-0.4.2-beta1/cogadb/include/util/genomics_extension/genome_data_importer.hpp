...
namespace CoGaDB {
    ...
    protected:
        ...
        struct contig_ids {
            ...
            contig_ids(TID _id_of_contig, TID _id_of_first_reference_base) : id_of_contig(_id_of_contig),
                                                                             id_of_first_reference_base(
                                                                                     _id_of_first_reference_base) { };
        };
        ...
        struct aux_info {
            ...
            aux_info(string _tag, string _type, string _value) : tag(_tag), type(_type), value(_value) { };
        };
        ...
        struct cigar_conversion {
            ...
            /* we assume that there at most the number of available read bases as deletions */
    ...
    public:
        ...
        * \brief Constructor.
        *
        * @param client Client enables access to system resources such as output streams.
        */
        ...
        */
        ...
        /**
        * \brief Method imports genome data from a FASTA file using the appropriate database schema into the database.
        *
        * @param path_to_fasta_file Path to FASTA file for import.
        * @param reference_genome_name Name of the imported reference genome. If left out or empty, the file name without
        * file ending is used as name.
        */
        virtual bool importReferenceGenomeData(const string path_to_fasta_file,
                                               const string reference_genome_name = "") = 0;

        /**
        * \brief Method imports genome data from a SAM or BAM file using the appropriate database schema into the database.
        *
        * @param path_to_sambam_file Path to SAM or BAM file for import.
        * @param reference_genome_name Name of the reference genome used for aligning the sample genome.
        * @param sample_genome_name Name of the imported sample genome. If left out or empty, the file name without file
        * ending is used as name.
        */
        virtual bool importSampleGenomeData(const string path_to_sambam_file, const string reference_genome_name,
