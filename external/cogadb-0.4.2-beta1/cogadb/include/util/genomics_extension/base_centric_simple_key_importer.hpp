...
/* some CIGAR related macros or only available since samtools 0.1.19 so define them here */
#ifndef bam_cigar_op
...
namespace CoGaDB {
    ...
    public:
        BaseCentric_SimpleKey_Importer(ostream &, bool compress_data = true, bool verbose = true);
