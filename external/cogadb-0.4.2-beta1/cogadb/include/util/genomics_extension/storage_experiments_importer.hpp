...
namespace CoGaDB {
    ...
    const string SB_BASE_VALUE_REFERENCECOMPRESSED_COL_NAME = "SB_BASE_VALUE_referencecompressed";
    const string SB_BASE_CALL_QUALITY_RLE_COL_NAME = "SB_BASE_CALL_QUALITY_rle";
    const string SB_BASE_CALL_QUALITY_BITPACKED_COL_NAME = "SB_BASE_CALL_QUALITY_bitpacked";
    ...
    private:
        ...
        bool _importAlignment(TID sample_genome_id, TID id_of_first_reference_base_in_contig, bam1_t *alignment,
                              const bam1_core_t c, TID read_id, TID mate_id, TID &sample_base_id,
