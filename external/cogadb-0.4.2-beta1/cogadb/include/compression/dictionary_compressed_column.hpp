...
namespace CoGaDB {
     ...
     */
    template<class T>
    class DictionaryCompressedColumn : public CompressedColumn<T>, public DictionaryCompressedCol {
    public:
        ...
        DictionaryCompressedColumn(const std::string& name, AttributeType db_type, const hype::ProcessingDeviceMemoryID& mem_id = hype::PD_Memory_0);
