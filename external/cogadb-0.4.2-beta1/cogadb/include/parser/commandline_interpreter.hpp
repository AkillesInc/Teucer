...
namespace CoGaDB {
    ...
    public:
        ...
        bool parallelExecution(const std::string& input, std::ifstream *in_stream, std::ofstream* log_file_for_timings);
        void threadedExecution(unsigned int thread_id, std::ofstream* log_file_for_timings, ClientPtr client);
    ...
    private:
        ...
        typedef bool (*ParameterizedCommandHandlerPtr)(const std::string&, ClientPtr);
