...
public:
    ...
    virtual bool column_algebra_operation(T* column, size_t num_elements, 
                                                T value, const AlgebraOperationParam&);
    ...
    virtual bool bit_shift(ColumnGroupingKeysPtr keys, const BitShiftParam& param);

    virtual bool bitwise_combination(ColumnGroupingKeysPtr target_keys, ColumnGroupingKeysPtr source_keys, const BitwiseCombinationParam& param);
    ...
    virtual const AggregationResult aggregate(T* aggregation_column, size_t num_elements, const AggregationParam&);
    ...
    virtual const PositionListPtr computePositionListSetOperation(PositionListPtr tids1, PositionListPtr tids2, const SetOperationParam&);
    /* END SET OPERATIONS */
    ...
    virtual const DoubleDenseValueColumnPtr convertToDoubleDenseValueColumn(const std::string& column_name, T* array, size_t value, const ProcessorSpecification& proc_spec) const;
    /* END MISC */
