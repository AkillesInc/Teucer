...
namespace CoGaDB {
    ...
    typedef std::list<std::pair<std::string,AggregationParam> > AggregationFunctions;
    ...
    public:
        AlgebraOperationParam(const ProcessorSpecification&, const ColumnAlgebraOperation&);
        ProcessorSpecification proc_spec;
    ...
    struct BitwiseCombinationParam{
        BitwiseCombinationParam(const ProcessorSpecification&, BitwiseCombinationOperation); 
        ProcessorSpecification proc_spec;
    ...
    class JoinParam {
    public:
        JoinParam(const ProcessorSpecification&, const JoinAlgorithm&, const JoinType& _join_type = INNER_JOIN);
        ProcessorSpecification proc_spec;
    ...
    public:
        SelectionParam(const ProcessorSpecification&, const PredicateType&, const boost::any&, const ValueComparator&);
        SelectionParam(const ProcessorSpecification&, const PredicateType&, ColumnPtr, const ValueComparator&);
        ProcessorSpecification proc_spec;
    ...
    class SortParam {
    public:
        SortParam(const ProcessorSpecification&, const SortOrder&, const bool& stable_sort=false);
        ProcessorSpecification proc_spec;
        SortOrder order;
        bool stable;
    };
