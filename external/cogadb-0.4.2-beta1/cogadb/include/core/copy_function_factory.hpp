...
namespace CoGaDB{
    ...
    class CopyFunctionFactory{
        public:
        typedef bool (*CopyFunctionPtr)(T* dest, const T* source, size_t number_of_bytes); 
        
        static CopyFunctionPtr getCopyFunction(const hype::ProcessingDeviceMemoryID& mem_id_dest, const hype::ProcessingDeviceMemoryID& mem_id_source);
        ...
        CopyFunctionPtr getCopyFunction_internal(const hype::ProcessingDeviceMemoryID& mem_id_dest, const hype::ProcessingDeviceMemoryID& mem_id_source);
    ...
    public:
        typedef bool (*MemsetFunctionPtr)(void* array, int value, size_t number_of_bytes); 
        static MemsetFunctionPtr getMemsetFunction(const hype::ProcessingDeviceMemoryID& mem_id);
