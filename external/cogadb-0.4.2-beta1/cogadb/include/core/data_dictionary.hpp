...
namespace CoGaDB{
    ...
    public:
        //returns a list of all columns with name column_name, toghether with their corresponding tables
        ...
        /*\brief 
          \result result stored in variable the reference type points to in case function returns true, if it return false the value the reference type to is not initialized!*/
