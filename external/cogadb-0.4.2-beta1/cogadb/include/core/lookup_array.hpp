...
//        virtual const PositionListPtr selection(ColumnPtr comparison_column, const ValueComparator comp);
	...
	virtual size_t getSizeinBytes() const throw();
        ...
        virtual shared_pointer_namespace::shared_ptr<ColumnBaseTyped<T> > getIndexedColumn();
...
//        virtual const AggregationResult aggregateByGroupingKeys(ColumnGroupingKeysPtr grouping_keys, AggregationMethod agg_meth, AggregationAlgorithm agg_alg); 
