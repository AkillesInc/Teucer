...
namespace CoGaDB {
    ...
    template <typename T>
    typename CPU_Join<T>::JoinFunctionPtr CPU_Join<T>::get(const JoinType& join_type) {
        ...
        if (!initialized) {
            ...
            map.insert(std::make_pair(RIGHT_OUTER_JOIN, &CPU_Join<T>::right_outer_join));
    ...
    template <typename T>
    const PositionListPairPtr CPU_Join<T>::left_outer_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
    ...
    template <typename T>
    const PositionListPairPtr CPU_Join<T>::right_outer_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
    ...
    template <typename T>
    const PositionListPairPtr CPU_Join<T>::full_outer_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
    ...
    template <typename T>
    typename CPU_Semi_Join<T>::TIDSemiJoinFunctionPtr CPU_Semi_Join<T>::getTIDSemiJoin(const JoinType& join_type) {
        ...
        static bool initialized = false;
        if (!initialized) {
            map.insert(std::make_pair(LEFT_SEMI_JOIN, &CPU_Semi_Join<T>::tid_left_semi_join));
            map.insert(std::make_pair(RIGHT_SEMI_JOIN, &CPU_Semi_Join<T>::tid_right_semi_join));
            map.insert(std::make_pair(LEFT_ANTI_SEMI_JOIN, &CPU_Semi_Join<T>::tid_left_anti_semi_join));
            map.insert(std::make_pair(RIGHT_ANTI_SEMI_JOIN, &CPU_Semi_Join<T>::tid_right_anti_semi_join));
            initialized = true;
        }
        if (map.find(join_type) != map.end()) {
            return map.find(join_type)->second;
    ...
    template <typename T>
    typename CPU_Semi_Join<T>::BitmapSemiJoinFunctionPtr CPU_Semi_Join<T>::getBitmapSemiJoin(const JoinType& join_type) {
    ...
    const PositionListPtr serial_tid_left_semi_join(T* join_column1,
        ...
        typedef boost::unordered_multimap<T, std::pair<TID, bool>, boost::hash<T>, std::equal_to<T> > HashTable;
     ...
     */
    template <typename T>
    const PositionListPtr optimized_left_smaller_right_tid_left_semi_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
     ...
     */
    template <typename T>
    const PositionListPtr optimized_left_greater_right_tid_left_semi_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
        ...
        typedef boost::shared_ptr<TypedHashTable> TypedHashTablePtr;
        typedef typename TypedHashTable::hash_bucket_t hash_bucket_t;
        typedef typename TypedHashTable::tuple_t tuple_t;
    ...
    template <typename T>
    const PositionListPtr CPU_Semi_Join<T>::tid_left_semi_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
...
//#define COGADB_TEST_CPU_SEMI_JOIN
        ...
        PositionListPtr tids1 = optimized_left_greater_right_tid_left_semi_join(join_column1, left_num_elements,
                join_column2, right_num_elements, param);
        Timestamp end = getTimestamp();
        
        std::cout << "Time Semi Join optimized_left_greater_right_tid_left_semi_join: " 
                  << double(end-begin)/(1000*1000) << "ms" << std::endl;
        
        begin = getTimestamp();
        PositionListPtr tids2 = optimized_left_smaller_right_tid_left_semi_join(join_column1, left_num_elements,
                join_column2, right_num_elements, param);
        end = getTimestamp();
        
        std::cout << "Time Semi Join optimized_left_smaller_right_tid_left_semi_join: " 
                  << double(end-begin)/(1000*1000) << "ms" << std::endl;
        ...
        if (left_num_elements <= right_num_elements) {
            return optimized_left_smaller_right_tid_left_semi_join(join_column1, left_num_elements,
                    join_column2, right_num_elements, param);
        } else {
            return optimized_left_greater_right_tid_left_semi_join(join_column1, left_num_elements,
                    join_column2, right_num_elements, param);
        }
    }

    template <>
    const PositionListPtr CPU_Semi_Join<std::string>::tid_left_semi_join(std::string* join_column1,
            size_t left_num_elements,
    ...
    template <>
    const PositionListPtr CPU_Semi_Join<char*>::tid_left_semi_join(char** join_column1,
            size_t left_num_elements,
            char** join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
    ...
    template <typename T>
    const PositionListPtr CPU_Semi_Join<T>::tid_right_semi_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {

        return CPU_Semi_Join<T>::tid_left_semi_join(join_column2,
                right_num_elements,
                join_column1,
                left_num_elements,
                param);
    ...
    template <typename T>
    const PositionListPtr CPU_Semi_Join<T>::tid_left_anti_semi_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
    ...
    template <typename T>
    const PositionListPtr CPU_Semi_Join<T>::tid_right_anti_semi_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
        ...
        return CPU_Semi_Join<T>::tid_left_anti_semi_join(join_column2,
                right_num_elements,
                join_column1,
                left_num_elements,
                param);
    ...
    template <typename T>
    const BitmapPtr CPU_Semi_Join<T>::bitmap_left_semi_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
    ...
    template <typename T>
    const BitmapPtr CPU_Semi_Join<T>::bitmap_right_semi_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
    ...
    template <typename T>
    const BitmapPtr CPU_Semi_Join<T>::bitmap_left_anti_semi_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
    ...
    template <typename T>
    const BitmapPtr CPU_Semi_Join<T>::bitmap_right_anti_semi_join(T* join_column1,
            size_t left_num_elements,
            T* join_column2,
            size_t right_num_elements,
            const JoinParam& param) {
