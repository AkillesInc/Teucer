...
bool compare_is_equal(PositionList& poslist, std::vector<TID>& reference_vector){
...
//            COGADB_ERROR("PositionListTest Unittest: push back and default constructor test failed!","");
//            return false;
//        }
//    }
////    if(!CoGaDB::quiet && CoGaDB::verbose && CoGaDB::debug)
...
////            PositionList poslist(random_number_of_elements,random_initializer);
////            std::vector<TID> reference_vector(random_number_of_elements,random_initializer);
////            //check correctness
////            if(!compare_is_equal(poslist,reference_vector)){
////                COGADB_ERROR("PositionListTest Unittest: fill constructor test failed!","");
////                return false;
////            }
////        }
////    }
...
//            //check correctness
//            if(!compare_is_equal(poslist,reference_vector)){
//                COGADB_ERROR("PositionListTest Unittest: range constructor test failed!","");
//                return false;
//            }
//        }
//    }
...
//                COGADB_ERROR("PositionListTest Unittest: copy constructor test failed!","");
//                return false;
//            }
//        }
//    }
...
//            std::vector<TID> reference_vector(poslist.begin(),poslist.end());
//            //check correctness
//            if(!compare_is_equal(copy_poslist,reference_vector)){
//                COGADB_ERROR("PositionListTest Unittest: copy constructor test failed!","");
//                return false;
...
//
//        if(!compare_is_equal(poslist,reference_vector)){
//            COGADB_ERROR("PositionListTest Unittest: reserve and capacity test failed!","");
//            return false;
//        }
//    }
//    if(!CoGaDB::quiet && CoGaDB::verbose && CoGaDB::debug)
//    cout << "test for correctness of range insert (empty PositionList)" << endl;
...
//                COGADB_ERROR("PositionListTest Unittest: range insert (empty PositionList) test failed!","");
//                return false;
//            }
//        }
//    }
//    if(!CoGaDB::quiet && CoGaDB::verbose && CoGaDB::debug)
//    std::cout << "test for correctness of range insert (non empty PositionList)" << std::endl;
...
//            //check correctness
//            if(!compare_is_equal(copy_poslist,copy_reference_vector)){
//                COGADB_ERROR("PositionListTest Unittest: range insert (non empty PositionList) test failed!","");
//                return false;
//            }
//        }
//    }
