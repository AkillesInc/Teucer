...
//
//column_processing::cpu::TypedOperatorPtr create_CPU_ColumnAlgebraOperator(column_processing::cpu::TypedLogicalNode& logical_node, const hype::SchedulingDecision& sched_dec, column_processing::cpu::TypedOperatorPtr left_child, column_processing::cpu::TypedOperatorPtr right_child)
//	{
//		logical_operator::Logical_CPU_ColumnAlgebraOperation& log_algebra_ref = static_cast<logical_operator::Logical_CPU_ColumnAlgebraOperation&>(logical_node);
...
//			std::cout << "Left Child of Node " << logical_node.getOperationName() << " (" << util::getName(log_algebra_ref.getColumnAlgebraOperation()) << ") is Invalid!" << std::endl;
//			exit(-1);
//		}
//		
//
...
//		return column_processing::cpu::TypedOperatorPtr(new CPU_ColumnAlgebraOperation(sched_dec,
//																		left_child, 
//																		right_child,
...
//                hype::AlgorithmSpecification col_algebra_alg_spec_cpu("CPU_ColumnAlgebra_Algorithm",
