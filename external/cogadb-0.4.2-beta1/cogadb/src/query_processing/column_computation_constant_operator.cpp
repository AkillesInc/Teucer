...
//Map_Init_Function init_function_sort_operator=physical_operator::map_init_function_column_constant_operator;

	namespace physical_operator{

	TypedOperatorPtr create_CPU_ColumnConstant_Operator(TypedLogicalNode& logical_node, const hype::SchedulingDecision& sched_dec, TypedOperatorPtr left_child, TypedOperatorPtr right_child)
	{
		logical_operator::Logical_ColumnConstantOperator& log_sort_ref = static_cast<logical_operator::Logical_ColumnConstantOperator&>(logical_node);
		...
		return TypedOperatorPtr(new CPU_ColumnConstantOperator(sched_dec,
		                        left_child,
		                        log_sort_ref.getColumnName(),
		                        log_sort_ref.getValue(),        
	...
	Physical_Operator_Map_Ptr map_init_function_column_constant_operator()
	{
		...
		hype::AlgorithmSpecification sort_alg_spec_cpu("CPU_ColumnConstant_Algorithm",
                                                                "ColumnConstantOperator",
                                                                hype::KNN_Regression,
                                                                hype::Periodic);	
	
		hype::AlgorithmSpecification sort_alg_spec_gpu("GPU_ColumnConstant_Algorithm",
                                                                "ColumnConstantOperator",
                                                                hype::KNN_Regression,
                                                                hype::Periodic);
#else
