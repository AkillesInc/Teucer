...
#define UINT64MAX UINT64_C(18446744073709551615)
    ...
    bool Storage_Experiments_Importer::_createDatabase() {
        ...
        rg_id_void_column = OIDTypedColumnPtr(new VoidCompressedColumnNumber<TID>(RG_ID_VOID_COL_NAME, OID));
        rg_name_column = StringTypedColumnPtr(new DictionaryCompressedColumn<std::string>(RG_NAME_COL_NAME, VARCHAR));
        // contig
        c_id_column = OIDTypedColumnPtr(new Column<TID>(C_ID_COL_NAME, OID));
        c_id_void_column = OIDTypedColumnPtr(new VoidCompressedColumnNumber<TID>(C_ID_VOID_COL_NAME, OID));
        c_name_column = StringTypedColumnPtr(new DictionaryCompressedColumn<std::string>(C_NAME_COL_NAME, VARCHAR));
        c_rg_id_column = OIDTypedColumnPtr(new Column<TID>(C_REF_GENOME_ID_COL_NAME, OID));
        c_rg_id_rle_column = OIDTypedColumnPtr(new RLECompressedColumn<TID>(C_REF_GENOME_ID_RLE_COL_NAME, OID));
        // reference base
        rb_id_column = OIDTypedColumnPtr(new Column<TID>(RB_ID_COL_NAME, OID));
        rb_id_void_column = OIDTypedColumnPtr(new VoidCompressedColumnNumber<TID>(RB_ID_VOID_COL_NAME, OID));
        ...
        rb_base_column = StringTypedColumnPtr(
                new DictionaryCompressedColumnForBaseValues<std::string>(RB_BASE_VALUE_COL_NAME, VARCHAR,
                                                                         dictionary, reverse_look_up_vector));
        ...
        rb_base_bitpacked_column = StringTypedColumnPtr(
                new BitPackedDictionaryCompressedColumnForBaseValues<std::string>(RB_BASE_VALUE_BITPACKED_COL_NAME,
                                                                                  VARCHAR,
                                                                                  bitpacked_dictionary,
                                                                                  bitpacked_reverse_look_up_vector, 3));
        rb_pos_column = IntTypedColumnPtr(
                new Column<int>(RB_POSITION_COL_NAME, INT));
        rb_pos_rledelta_column = IntTypedColumnPtr(
                new RLEDeltaOneCompressedColumnNumber<int>(RB_POSITION_RLEDELTAONE_COL_NAME, INT));
        rb_c_id_column = OIDTypedColumnPtr(new Column<TID>(RB_CONTIG_ID_COL_NAME, OID));
        rb_c_id_rle_column = OIDTypedColumnPtr(new RLECompressedColumn<TID>(RB_CONTIG_ID_RLE_COL_NAME, OID));
        ...
        sg_id_void_column = OIDTypedColumnPtr(new VoidCompressedColumnNumber<TID>(SG_ID_VOID_COL_NAME, OID));
        sg_name_column = StringTypedColumnPtr(new DictionaryCompressedColumn<std::string>(SG_NAME_COL_NAME, VARCHAR));
        // read
        r_id_column = OIDTypedColumnPtr(new Column<TID>(R_ID_COL_NAME, OID));
        r_id_void_column = OIDTypedColumnPtr(new VoidCompressedColumnNumber<TID>(R_ID_VOID_COL_NAME, OID));
        r_qname_column = StringTypedColumnPtr(new DictionaryCompressedColumn<std::string>(R_QNAME_COL_NAME, VARCHAR));
        r_sg_id_column = OIDTypedColumnPtr(new Column<TID>(R_SAMPLE_GENOME_ID_COL_NAME, OID));
        r_sg_id_rle_column = OIDTypedColumnPtr(new RLECompressedColumn<TID>(R_SAMPLE_GENOME_ID_RLE_COL_NAME, OID));
        r_map_qual_column = IntTypedColumnPtr(new Column<int>(R_MAPPING_QUALITY_COL_NAME, INT));
        r_map_qual_rle_column = IntTypedColumnPtr(new RLECompressedColumn<int>(R_MAPPING_QUALITY_RLE_COL_NAME, INT));
        r_map_qual_bitpacked_column = IntTypedColumnPtr(
                new BitPackedDictionaryCompressedColumn<int>(R_MAPPING_QUALITY_BITPACKED_COL_NAME, INT, 8));
        r_flag_column = IntTypedColumnPtr(new Column<int>(R_FLAG_COL_NAME, INT));
        r_flag_rle_column = IntTypedColumnPtr(new RLECompressedColumn<int>(R_FLAG_RLE_COL_NAME, INT));
        r_flag_bitpacked_column = IntTypedColumnPtr(
                new BitPackedDictionaryCompressedColumn<int>(R_FLAG_BITPACKED_COL_NAME, INT, 16));
        r_mate_id_column = OIDTypedColumnPtr(new Column<TID>(R_MATE_ID_COL_NAME, OID));
        // sample base
        sb_id_column = OIDTypedColumnPtr(new Column<TID>(SB_ID_COL_NAME, OID));
        sb_id_void_column = OIDTypedColumnPtr(new VoidCompressedColumnNumber<TID>(SB_ID_VOID_COL_NAME, OID));
        sb_rb_id_column = OIDTypedColumnPtr(new Column<TID>(SB_RB_ID_COL_NAME, OID));
        sb_rb_id_rledelta_column = OIDTypedColumnPtr(
                new RLEDeltaOneCompressedColumnNumber<TID>(SB_RB_ID_RLEDELTAONE_COL_NAME, OID));
        sb_r_id_column = OIDTypedColumnPtr(new Column<TID>(SB_READ_ID_COL_NAME, OID));
        sb_r_id_rle_column = OIDTypedColumnPtr(new RLECompressedColumn<TID>(SB_READ_ID_RLE_COL_NAME, OID));
        sb_base_column = StringTypedColumnPtr(
                new DictionaryCompressedColumnForBaseValues<std::string>(SB_BASE_VALUE_COL_NAME, VARCHAR,
                                                                         dictionary, reverse_look_up_vector));
        sb_base_bitpacked_column = StringTypedColumnPtr(
                new BitPackedDictionaryCompressedColumnForBaseValues<std::string>(
                        SB_BASE_VALUE_BITPACKED_COL_NAME, VARCHAR,
                        bitpacked_dictionary,
                        bitpacked_reverse_look_up_vector, 3));
        sb_base_reference_based_column = StringTypedColumnPtr(
                new ReferenceBasedCompressedColumn<std::string>(SB_BASE_VALUE_REFERENCECOMPRESSED_COL_NAME, VARCHAR,
                                                                SB_TBL_NAME,
                                                                SB_RB_ID_COL_NAME, RB_TBL_NAME,
                                                                RB_BASE_VALUE_COL_NAME));
        sb_insert_column = IntTypedColumnPtr(new Column<int>(SB_INSERT_OFFSET_COL_NAME, INT));
        sb_insert_rle_column = IntTypedColumnPtr(new RLECompressedColumn<int>(SB_INSERT_OFFSET_RLE_COL_NAME, INT));
        sb_qual_column = IntTypedColumnPtr(new Column<int>(SB_BASE_CALL_QUALITY_COL_NAME, INT));
        sb_qual_rle_column = IntTypedColumnPtr(
                new RLECompressedColumn<int>(SB_BASE_CALL_QUALITY_RLE_COL_NAME, INT));
        sb_qual_bitpacked_column = IntTypedColumnPtr(
                new BitPackedDictionaryCompressedColumn<int>(SB_BASE_CALL_QUALITY_BITPACKED_COL_NAME, INT, 8));
        ...
        if (sb_base_reference_based_column->getColumnType() == REFERENCE_BASED_COMPRESSED) {
            boost::shared_ptr<ReferenceBasedCompressedColumn<string> > sb_base_column_typed =
    ...
    bool Storage_Experiments_Importer::_initDatabaseConnection() {
        ...
        for (std::vector<TablePtr>::const_iterator table = tables.begin(); table != tables.end(); ++table) {
        ...
        if (existing_tables == 6) {
            ...
            rb_base_bitpacked_column = boost::dynamic_pointer_cast<StringTypedColumnType>(
            ...
            r_map_qual_bitpacked_column = boost::dynamic_pointer_cast<IntTypedColumnType>(
            ...
            sb_base_bitpacked_column = boost::dynamic_pointer_cast<StringTypedColumnType>(
                    sampleBaseTable->getColumnbyName(SB_BASE_VALUE_BITPACKED_COL_NAME));
            assert(sb_base_bitpacked_column != NULL);
            sb_base_reference_based_column = boost::dynamic_pointer_cast<StringTypedColumnType>(
                    sampleBaseTable->getColumnbyName(SB_BASE_VALUE_REFERENCECOMPRESSED_COL_NAME));
            ...
            sb_qual_bitpacked_column = boost::dynamic_pointer_cast<IntTypedColumnType>(
                    sampleBaseTable->getColumnbyName(SB_BASE_CALL_QUALITY_BITPACKED_COL_NAME));
            ...
            this->out <<
            "ERROR: There is at least one existing table. Database corrupted? Or other schema present? Aborting ..." <<
            std::endl;
            return false;
        }
    }

    Storage_Experiments_Importer::Storage_Experiments_Importer(ostream &_out, bool _verbose)
            : GenomeDataImporter(_out, true, _verbose) {
        this->_initDatabaseConnection();
    };

    bool Storage_Experiments_Importer::_importReferenceGenomeData(const string reference_genome_name,
        ...
        if (fastaFile.is_open()) {
            ...
            while (getline(fastaFile, fastaLine)) {
                if (fastaLine[0] == '>') {
                    ...
                    //Tuple contigTuple;
                    // Search for first while space in the contig name to cut a meaningful contig name.
                    // If the name does not contain a white the return value is string::npos, which means the following
        ...
        std::pair<double, string> time = _getTimeAsHumanReadableString(end_preparation);
        out << "Time to PREPARE import: " << time.first << time.second << " (" << end_preparation << "ns)" << endl;
        time = _getTimeAsHumanReadableString(end_importing);
        out << "Time to IMPORT reference data: " << time.first << time.second << " (" << end_importing << "ns)" << endl;
        time = _getTimeAsHumanReadableString(end_storing);
        out << "Time to STORE data on disk: " << time.first << time.second << " (" << end_storing << "ns)" << endl;

        return true;
    }

    bool Storage_Experiments_Importer::importReferenceGenomeData(const string path_to_fasta_file,
        ...
        bool success = false;
        success = _importReferenceGenomeData(reference_genome_name, path_to_fasta_file);
        if (success) {
            out << " SUCCESS!" << endl;
     ...
     */
    bool Storage_Experiments_Importer::_importAlignment(TID sample_genome_id, TID id_of_first_reference_base_in_contig,
                                                        bam1_t *alignment,
                                                        const bam1_core_t c,
                                                        TID read_id, TID mate_id, TID &sample_base_id,
        ...
        r_flag_rle_column->insert((int) c.flag);
        r_flag_bitpacked_column->insert((int) c.flag);
        r_map_qual_column->insert((int) c.qual);
        r_map_qual_rle_column->insert((int) c.qual);
        r_map_qual_bitpacked_column->insert((int) c.qual);
        r_mate_id_column->insert(mate_id);

        assert(sb_base_reference_based_column->getColumnType() == REFERENCE_BASED_COMPRESSED);
        boost::shared_ptr<ReferenceBasedCompressedColumn<string> > sb_base_value_referenced =
                boost::dynamic_pointer_cast<ReferenceBasedCompressedColumn<string> >(sb_base_reference_based_column);
        assert(sb_base_value_referenced != NULL);

        /* iterate through the sequence */
        for (i = 0; i < (c.l_qseq - (converted_cigar.start_offset + converted_cigar.end_offset)); ++i) {
            base_value = "";
            base_value += bam_nt16_rev_table[bam1_seqi(baseSequence,
                                                       (i + converted_cigar.start_offset))];
            if (qualityValues[0] == 0xff) {
                base_call_quality = '*';
            } else {
                base_call_quality = (char) (qualityValues[i + converted_cigar.start_offset]);
                avg_base_call_quality += base_call_quality;
            }
            TID sb_rb_id = id_of_first_reference_base_in_contig + pos + (int) converted_cigar.positions[i];
        ...
        for (i = 0; i < converted_cigar.del_end_offset; i++) {
            base_value = "X";
            TID sb_rb_id = id_of_first_reference_base_in_contig + pos + (int) converted_cigar.deleted_positions[i];
            sb_id_column->insert(sample_base_id);
            sb_id_void_column->insert(sample_base_id);
            sb_rb_id_column->insert(sb_rb_id);
            sb_rb_id_rledelta_column->insert(sb_rb_id);
    ...
    bool Storage_Experiments_Importer::_importSampleGenomeData(string sample_genome_name,
                                                               TID reference_genome_id,
                                                               string path_to_sam_bam_file,
                                                               TID &numberOfUnmappedReads, TID &numberOfReads) {
        Timestamp start = getTimestamp();
        Timestamp end_preparation = 0;
        ...
        // Prepare import information: Contig names, their database ids and the id of the first reference within the contig (min(id))
        // The corresponding SQL query: select c_name, c_id, min(rb_id) from contig join reference_base on c_id = rb_c_id
        ...
        map<string, contig_ids> contigName2IdMap;
        {
            ...
            contig_TIDs = c_rg_id_column->selection(
                    SelectionParam(processorSpecification, ValueConstantPredicate, reference_genome_id, EQUAL));

            if (contig_TIDs->size() == 0) {
                out << "ERROR: Couldn't find contigs for " << reference_genome_id << "." << endl;
                return false;
            }

            ColumnPtr selected_contig_ids = c_id_column->gather(contig_TIDs, GatherParam(processorSpecification));
            // contig join reference_base on c_id = rb_c_id - first TID list for contig, second for rb
            PositionListPairPtr join_pair = selected_contig_ids->join(rb_c_id_column,
                                                                      JoinParam(processorSpecification, HASH_JOIN));

            ColumnPtr joined_contig_ids = c_id_column->gather(join_pair->first, GatherParam(processorSpecification));
            ColumnPtr joined_contig_names = c_name_column->gather(join_pair->first,
                                                                  GatherParam(processorSpecification));
            ColumnPtr joined_rb_ids;
            if (rb_id_column->getColumnType() == VOID_COMPRESSED_NUMBER) {
                // VOID COMPRESSED mainly works for primary key columns with incrementing keys
                // PK FK join yields a result where every FK TID appears exactly once
                // Thus, a gather is not needed as the join already computes the required TIDs that are also stored
                // in a void_compressed column like rb_id_column
                joined_rb_ids = boost::dynamic_pointer_cast<ColumnBase>(join_pair->second);
                assert(joined_rb_ids != NULL);
            } else {
                joined_rb_ids = rb_id_column->gather(join_pair->second, GatherParam(processorSpecification));
            }
            ...
            ColumnGroupingKeysPtr grouping_keys = CDK::aggregation::computeColumnGroupingKeys(grouping_columns,
                                                                                              processorSpecification);
            // Result are two ColumnPtr: 1st contains TID of grouping columns to get values, 2nd aggregated values
            AggregationResult aggregation_result = joined_rb_ids->aggregateByGroupingKeys(grouping_keys,
                                                                                          AggregationParam(
                                                                                                  processorSpecification,
                                                                                                  MIN,
            ...
            OIDTypedColumnPtr queried_contig_ids_typed = boost::dynamic_pointer_cast<OIDTypedColumnType>(
                    grouped_contig_ids);
            assert(queried_contig_ids_typed != NULL);
            if (queried_contig_ids_typed->getColumnType() != PLAIN_MATERIALIZED) {
                queried_contig_ids = queried_contig_ids_typed->copyIntoDenseValueColumn(processorSpecification);
            } else {
                queried_contig_ids = boost::dynamic_pointer_cast<Column<TID> >(grouped_contig_ids);
                assert(queried_contig_ids != NULL);
            }

            StringTypedColumnPtr queried_contig_names_typed = boost::dynamic_pointer_cast<StringTypedColumnType>(
                    grouped_contig_names);
            assert(queried_contig_names_typed != NULL);
            queried_contig_names = queried_contig_names_typed->copyIntoDenseValueColumn(processorSpecification);

            OIDTypedColumnPtr queried_aggregation_results_typed = boost::dynamic_pointer_cast<OIDTypedColumnType>(
                    aggregation_result.second);
            assert(queried_aggregation_results_typed != NULL);
            if (queried_contig_ids_typed->getColumnType() != PLAIN_MATERIALIZED) {
                queried_aggregation_results = queried_aggregation_results_typed->copyIntoDenseValueColumn(
                        processorSpecification);
            } else {
            ...
            for (TID i = 0; i < queried_contig_ids->size(); i++) {
                contigName2IdMap.insert(make_pair(contig_names[i], contig_ids(contig_ids_[i], rb_ids[i])));
            }
        }
        ...
        if (_endsWithFoo(path_to_sam_bam_file.c_str(), ".sam") == 0) {
            alignmentFile = boost::shared_ptr<AlignmentFile>(new SAMFile(path_to_sam_bam_file));
        } else if (_endsWithFoo(path_to_sam_bam_file.c_str(), ".bam") == 0) {
            alignmentFile = boost::shared_ptr<AlignmentFile>(new BAMFile(path_to_sam_bam_file));
        } else {
        ...
        if (verbose) {
            ...
            if (overallCount == 0) {
                out << "No alignments found in file " << path_to_sam_bam_file << "! Aborting ..." << endl;
                return false;
            }
        ...
        /* After counting scan again and use the overall count to determine the progress */
        uint64_t count = 0;
        ...
        while (alignmentFile->getNextAlignment(loop_alignment) >= 0) {
            ...
            // TODO one of these is faster: http:/("");/stackoverflow.com/questions/191757/c-concatenate-string-and-int
            ...
            map<string, bam1_t *>::const_iterator mate_iterator = mate_map.find(mate_key);
            if (mate_iterator != mate_map.end()) {
                // mate found - import both
                // check whether mate can be imported
                // An offset below 0 means that the alignment has no coordinates, we do not support this in the
                // moment. Moreover, the offset is used for looking up contig IDs. If the offset is greater than the
                ...
                if ((mate_core.flag & BAM_FUNMAP) == 0 && mate_core.tid >= 0 &&
                    ...
                    contigNameMate = string(alignmentFile->getHeader()->target_name[chromosome_id]);
                    map<string, contig_ids>::iterator it = contigName2IdMap.find(contigName);
                    if (it != contigName2IdMap.end()) {
                        id_of_first_reference_base_in_contig_mate = it->second.id_of_first_reference_base;
                    } else {
                ...
                if ((core.flag & BAM_FUNMAP) == 0 && chromosome_id >= 0 &&
                    ...
                    contigName = string(alignmentFile->getHeader()->target_name[chromosome_id]);
                    map<string, contig_ids>::iterator it = contigName2IdMap.find(contigName);
                    if (it != contigName2IdMap.end()) {
                        id_of_first_reference_base_in_contig = it->second.id_of_first_reference_base;
                    } else {
                        //    out << "Could not find contig id in database for contig name "
                        //    << contigName << ". Skipping alignment ..." << endl;
                ...
                if (import_mate_id < UINT64MAX && id_of_first_reference_base_in_contig_mate < UINT64MAX) {
                    ...
                    //    cigar_lookup_key += x * cigar[x];// << mate_core.n_cigar;// << position_mate;
                    //}
                    //assert(cigar_lookup_key > 0);
                    //map<TID, cigar_conversion>::iterator it = cigar_conversion_cache.find(
                    //        cigar_lookup_key);
                    cigar_conversion converted_cigar(mate_core.l_qseq);
                    //if (it == cigar_conversion_cache.end()) {
                    /* do CIGAR conversion */
                    _convertCIGAR(cigar, mate_core.n_cigar, mate_core.pos, &converted_cigar);
                    //    cigar_conversion_cache.insert(std::make_pair(cigar_lookup_key, converted_cigar));
                    //} else {
                    //    cigar_cache_hits++;
                    //    converted_cigar = it->second;
                    //}
                    _importAlignment(sample_genome_id, id_of_first_reference_base_in_contig_mate, alignment_mate,
                                     mate_core, import_mate_id, import_read_id, sample_base_id, converted_cigar);
                } else {
                    // no coordinates, unmapped read FIXME
                    ++numberOfUnmappedReads;
                }
                if (import_read_id < UINT64MAX && id_of_first_reference_base_in_contig < UINT64MAX) {
                    uint32_t *cigar = bam1_cigar(alignment);
                    //TID cigar_lookup_key = 0;//string_key_maker.str();
                    //std::stringstream string_key_maker;
                    ...
                    //    converted_cigar = it->second;
                    //}
                    _importAlignment(sample_genome_id, id_of_first_reference_base_in_contig, alignment,
                                     core, import_read_id, import_mate_id, sample_base_id, converted_cigar);
                } else {
                    // no coordinates, unmapped read FIXME
                    ++numberOfUnmappedReads;
                }
        ...
        for (mate_map_iterator_type read_iterator = mate_map.begin();
            ...
            if ((nomate_core.flag & BAM_FUNMAP) == 0 && nomate_core.tid >= 0 &&
                ...
                contigName = string(alignmentFile->getHeader()->target_name[nomate_core.tid]);
                map<string, contig_ids>::iterator it = contigName2IdMap.find(contigName);
                if (it != contigName2IdMap.end()) {
                    id_of_first_reference_base_in_contig = it->second.id_of_first_reference_base;
                } else {
            ...
            if (import_id < UINT64MAX && id_of_first_reference_base_in_contig < UINT64MAX) {
                ...
                //}
                //assert(cigar_lookup_key > 0);
                //map<TID, cigar_conversion>::iterator it = cigar_conversion_cache.find(cigar_lookup_key);
                cigar_conversion converted_cigar(nomate_core.l_qseq);
                //if (it == cigar_conversion_cache.end()) {
                /* do CIGAR conversion */
                _convertCIGAR(cigar, nomate_core.n_cigar, nomate_core.pos, &converted_cigar);
                //    cigar_conversion_cache.insert(std::make_pair(cigar_lookup_key, converted_cigar));
                //} else {
                //    cigar_cache_hits++;
                //    converted_cigar = it->second;
                //}
                _importAlignment(sample_genome_id, id_of_first_reference_base_in_contig, alignment_nomate,
                                 nomate_core, import_id, -1, sample_base_id, converted_cigar);
            } else {
                ++numberOfUnmappedReads;
            }
            count++;
        ...
        out << "Time to COUNT alignments: " << time.first << time.second << " (" << end_counting << "ns)" << endl;
        time = _getTimeAsHumanReadableString(end_importing);
        out << "Time to IMPORT alignments: " << time.first << time.second << " (" << end_importing << "ns)" << endl;
        time = _getTimeAsHumanReadableString(end_storing);
        out << "Time to STORE data on disk: " << time.first << time.second << " (" << end_storing << "ns)" << endl;
    ...
    bool Storage_Experiments_Importer::importSampleGenomeData(const string path_to_sam_bam_file,
                                                              const string reference_genome_name,
        ...
        // Determine current reference genome id
        {
            ...
            SelectionParam param(proc_spec, ValueConstantPredicate, reference_genome_name, EQUAL);
        ...
        success = _importSampleGenomeData(sample_genome_name, reference_genome_id, path_to_sam_bam_file,
                                          numberOfUnmappedReads, numberOfReads);
        if (success) {
            out << " SUCCESS!" << endl;
            out << "Following tables were imported:" << endl;
            out << sampleGenomeTable->getName() << "(" << sampleGenomeTable->getNumberofRows() << " rows, " <<
            sampleGenomeTable->getSizeinBytes() << " bytes)" << endl;
            out << readTable->getName() << "(" << readTable->getNumberofRows() << " rows, " <<
            readTable->getSizeinBytes() << " bytes)" << endl;
            out << sampleBaseTable->getName() << "(" << sampleBaseTable->getNumberofRows() << " rows, " <<
            sampleBaseTable->getSizeinBytes() << " bytes)" << endl;
            if (numberOfReads > 0) {
                out << "Sample genome statistics:" << endl;
                out << "Overall reads: " << numberOfReads << endl;
                out << "Number of Unmapped reads: " << numberOfUnmappedReads << " ( " << setprecision(2) <<
                (
                        double(numberOfUnmappedReads)
                        / numberOfReads * 100) << "% )" <<
                endl;
                out << "Number of Mapped reads: " << (numberOfReads - numberOfUnmappedReads) << " ( " <<
                setprecision(2) << (
                        double(numberOfReads
                               - numberOfUnmappedReads) / numberOfReads * 100) << "% )" <<
                endl;
            }
        } else {
            out << " ERROR!" << endl;
