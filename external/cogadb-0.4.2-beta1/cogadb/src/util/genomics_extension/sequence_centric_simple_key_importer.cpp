...
#define UINT64MAX 18446744073709551615UL
    ...
    SequenceCentric_SimpleKey_Importer::SequenceCentric_SimpleKey_Importer(ostream &_out, bool _compress_data,
                                                                           bool _verbose)
            : GenomeDataImporter(_out, _compress_data, _verbose) {
        this->_initDatabaseConnection();
    };

    bool SequenceCentric_SimpleKey_Importer::_importReferenceGenomeData(const string reference_genome_name,
    ...
    bool SequenceCentric_SimpleKey_Importer::importReferenceGenomeData(const string path_to_fasta_file,
    ...
    std::vector<GenomeDataImporter::aux_info> SequenceCentric_SimpleKey_Importer::getAuxiliaryStringVector(bam1_t *alignment) {
 ...
 */
    bool SequenceCentric_SimpleKey_Importer::_importAlignment(TID sample_genome_id,
                                                              TID id_of_contig,
                                                              bam1_t *alignment,
    ...
    string SequenceCentric_SimpleKey_Importer::convertCIGAR2String(uint32_t *cigar, uint32_t cigarLength) {
    ...
    bool SequenceCentric_SimpleKey_Importer::_importSampleGenomeData(string sample_genome_name,
    ...
    bool SequenceCentric_SimpleKey_Importer::importSampleGenomeData(const string path_to_sam_bam_file,
                                                                    const string reference_genome_name,
