...
namespace CoGaDB {
    ...
    AlignmentFile::AlignmentFile(string _path_to_alignment_file) : path_to_alignment_file(_path_to_alignment_file) { };

    AlignmentFile::~AlignmentFile() { };

    BAMFile::BAMFile(string _path_to_alignment_file) : AlignmentFile(_path_to_alignment_file) { };
    ...
    SAMFile::SAMFile(string _path_to_alignment_file) : AlignmentFile(_path_to_alignment_file) { };
