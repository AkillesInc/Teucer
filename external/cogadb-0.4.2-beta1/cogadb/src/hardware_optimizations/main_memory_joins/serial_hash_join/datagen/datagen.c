 ...
 */
relation_t
gen_unique (unsigned long num_tuples)
{
 ...
 */
static double *
gen_zipf_lut (double zipfparam, unsigned long alphabet_size)
{
...
relation_t
gen_zipf (unsigned long num_tuples, unsigned long alphabet_size, double zipfparam)
{
    tuple_t *tuples;
