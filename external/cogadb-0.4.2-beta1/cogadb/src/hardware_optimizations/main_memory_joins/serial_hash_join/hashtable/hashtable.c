...
hashtable_t *
hash_new (const unsigned int num_tuples)
{
    hashtable_t  *ret;
...
void
hash_put (hashtable_t *hashtable, const tuple_t tuple)
{
    unsigned int    hash;
    hash_bucket_t  *bucket;
...
bool
hash_get_first (const hashtable_t *hashtable, const ht_key_t key, ht_value_t *val)
{
    unsigned int    hash;
    hash_bucket_t  *bucket;
...
static void
bucket_release (hash_bucket_t *bucket)
{
    if (!bucket)
        return;
    else
...
void
hash_release (hashtable_t *hashtable)
{
