...
namespace hype{
														  ...
														  feature_values_(feature_values)
	{
        ...
        SchedulingDecision::SchedulingDecision(Algorithm& alg_ref,
                                               const EstimatedTime& estimated_time_for_algorithm, 
                                               const Tuple& feature_values, 
...
//        SchedulingDecision::SchedulingDecision(const hype::core::SchedulingDecision& other) : alg_ref_(other.alg_ref_),
...
//        }
//
//        SchedulingDecision& SchedulingDecision::operator=(const hype::core::SchedulingDecision& other){
//            
//            //prevent self assignment
//            if( this != &other ) {
//                this->alg_ref_ = other.alg_ref_;
//                this->estimated_time_for_algorithm_ = other.estimated_time_for_algorithm_;
...
//                return name.substr(0,pos); //return the original algorithm name, which is independent of the device type
	}

	const EstimatedTime SchedulingDecision::getEstimatedExecutionTimeforAlgorithm() const{
	...
	const DeviceSpecification SchedulingDecision::getDeviceSpecification() const throw(){
