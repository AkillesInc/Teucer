...
//
//                            DeviceMemoryPtr dev_mem = DeviceMemories::instance().getDeviceMemory(sched_dec.getDeviceSpecification().getMemoryID());
//                            MemoryChunkPtr mem_chunk = dev_mem->allocateMemory(0);
//                                
//                         }
			 return sched_dec;
