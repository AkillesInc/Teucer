...
namespace hype{
	...
	EstimatedTime::EstimatedTime(double time_in_nanoseconds) : value_in_nanoseconds_(time_in_nanoseconds){
	...
	MeasuredTime::MeasuredTime(double time_in_nanoseconds) : value_in_nanoseconds_(time_in_nanoseconds){
