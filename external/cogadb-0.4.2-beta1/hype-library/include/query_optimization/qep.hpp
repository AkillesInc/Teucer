...
namespace hype{
	namespace query_optimization{
                ...
                struct QEP_Node{
                        ...
                        QEP_Node(const core::OperatorSpecification& op_spec_arg, const core::DeviceConstraint& dev_constr_arg, bool input_data_cached = false);
                        ...
                        void assignAlgorithm(core::Algorithm* alg_ptr, const core::EstimatedTime est_exec_time);
                ...
                template <typename UnaryFunction>
                void QEP_Node::traverse_preorder(UnaryFunction& functor, unsigned int level){
                    functor(this,level);
                ...
                public:
                    ...
                    std::string toString(unsigned int indent=0, bool enable_colors=true, bool print_node_numbers=false);
