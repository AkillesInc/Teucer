...
namespace hype {
    namespace queryprocessing {
        ...
        /*! \todo add query id to operator, so it can be easily identified, which query an operator belongs to*/
        ...
        public:
            ...
            TypedOperator(const hype::SchedulingDecision& sched_dec) : Operator(sched_dec), result_(), out(&std::cout){
                //result_size_=0;
            }
...
//            }
            ...
            virtual void print(std::ostream& out, unsigned int tree_level = 0) const = 0;
            virtual void printResult(std::ostream& out, unsigned int tree_level = 0, bool show_timings=false, bool show_cardinalities=false, bool show_estimation_error=false) = 0;
