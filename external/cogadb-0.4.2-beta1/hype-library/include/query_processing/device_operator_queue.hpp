	...
	namespace queryprocessing
	{
		...
		{  
                ...
                public:
                    ...
                    DeviceOperatorQueuePtr getDeviceOperatorQueue(const ProcessingDeviceMemoryID mem_id);
                private:
                        ...
                        typedef std::map<ProcessingDeviceMemoryID,DeviceOperatorQueuePtr> DeviceOperatorQueueMap;
                        DeviceOperatorQueueMap map_;
                };
                
                
//                   DeviceOperatorQueue::DeviceOperatorQueue(const ProcessingDeviceMemoryID mem_id)
//                   : operators_(), new_operator_available_(), operator_queue_full_(), operator_mutex_(),
//                     mem_id_(mem_id), estimated_execution_time_for_operators_in_queue_to_complete_(0)
//                   {
//                       
//                   }
//                   //Note that this method locks the scoped lock 'lock', and if this function returns, 'lock' is locked
//                   OperatorPtr DeviceOperatorQueue::getNextOperator(){//boost::mutex::scoped_lock& lock){
...
//                    }
//                   
//                    static DeviceOperatorQueues& DeviceOperatorQueues::instance(){
//                        static DeviceOperatorQueues queues;
//                        return queues;
//                    }
//                    
//                    DeviceOperatorQueuePtr DeviceOperatorQueues::getDeviceOperatorQueue(const ProcessingDeviceMemoryID mem_id){
