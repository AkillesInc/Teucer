...
namespace hype
{
	namespace queryprocessing
	{
		...
		public:
			explicit VirtualProcessingDevice(const core::DeviceSpecification& dev_spec_);
			
			bool addRunningOperation(const core::SchedulingDecision&); //called by getOptimalAlgorithm
			
			bool removeFinishedOperation(const core::SchedulingDecision&); //called by addObservation
		...
		typedef boost::shared_ptr<VirtualProcessingDevice> VirtualProcessingDevicePtr;
