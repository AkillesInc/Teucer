...
namespace hype {
    namespace queryprocessing {
        ...
        public:
            ...
            virtual ~Operator();
        protected:
            Operator(const hype::core::SchedulingDecision& sched_dec); // : sched_dec_(sched_dec) {}
            Operator(const hype::core::SchedulingDecision& sched_dec, NodePtr logical_operator);
