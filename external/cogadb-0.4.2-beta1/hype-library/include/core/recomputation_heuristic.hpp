...
//factory function
const boost::shared_ptr<RecomputationHeuristic_Internal> getNewRecomputationHeuristicbyName(std::string name);

typedef core::Factory<RecomputationHeuristic_Internal, std::string> RecomputationHeuristicFactory; //aFactory;
//typedef Loki::Singleton<RecomputationHeuristicFactory> RecomputationHeuristicFactorySingleton;
