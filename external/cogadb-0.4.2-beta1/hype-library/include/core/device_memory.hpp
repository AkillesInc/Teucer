/***********************************************************************************************************
Copyright (c) 2014, Sebastian Breß, TU Dortmund University, Germany. All rights reserved.
...
namespace hype{
	...
	namespace core{
		...
		class DeviceMemory{
			public:
                        DeviceMemory(size_t total_memory_in_bytes, ProcessingDeviceMemoryID mem_id);
		...
		public:		
			...
			bool addDeviceMemory(ProcessingDeviceMemoryID mem_id, size_t total_memory_in_bytes);
		private:
			DeviceMemories();
