...
//	void setRecomputationHeuristic(RecomputationHeuristic& recomp_heuristic){
//		this->recomp_heuristic_=recomp_heuristic;
//	}

	const bool addObservation(std::string name_of_algorithm, const Measurementpair& mp);//;
//	{

//		//if RecomputationHeuristic.recompute(alg) then algorithm.statistical_method.recomputeApproximationFunction();
//	}
