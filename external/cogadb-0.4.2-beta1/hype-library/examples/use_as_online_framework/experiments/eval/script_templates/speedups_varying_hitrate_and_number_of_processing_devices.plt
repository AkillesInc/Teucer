...
set arrow from 0,1 to 20,1 as 1
...
#set label "speedup=1" at graph(0,0.85),0.98
...
plot "wtar_results_2d_plot.data" using 6:($1==0?$9/$7:1/0) title "CHR=0.0" w lp lw 4, \
"wtar_results_2d_plot.data" using 6:($1==0.5?$9/$7:1/0) title "CHR=0.5" w lp lw 4, \
"wtar_results_2d_plot.data" using 6:($1==1?$9/$7:1/0) title "CHR=1.0" w lp lw 4
