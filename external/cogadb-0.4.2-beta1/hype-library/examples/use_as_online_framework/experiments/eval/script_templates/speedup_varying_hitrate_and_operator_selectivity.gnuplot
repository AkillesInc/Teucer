...
set ylabel "average operator selectivity" font "Times Bold, 18"
...
splot  "wtar_results.data" using 1:7:($10/$8) notitle with pm3d nohidden3d nocontour, \
	"wtar_results.data" using 1:7:($10/$8) title "speedup with transfers" with lines linecolor rgb "#3f3f3f" nohidden3d
