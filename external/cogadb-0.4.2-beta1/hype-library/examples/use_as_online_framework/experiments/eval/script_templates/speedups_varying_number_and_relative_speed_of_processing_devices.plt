...
plot "wtar_results_2d_plot.data" using 6:($1==0.1?$9/$7:1/0) title "RS=0.1" w lp lw 4, \
"wtar_results_2d_plot.data" using 6:($1==1?$9/$7:1/0) title "RS=1.0" w lp lw 4, \
"wtar_results_2d_plot.data" using 6:($1==10?$9/$7:1/0) title "RS=10.0" w lp lw 4
